...
public class BlockMaskWidget extends MaskWidget {
   ...
   public BlockMaskWidget() {
      this.blockConditionWidget = new BlockConditionWidget(Blocks.STONE);
   }
   ...
   public BlockMaskWidget(BlockConditionWidget.BlockConditionState state) {
      this.blockConditionWidget = new BlockConditionWidget(Blocks.STONE);
   ...
   public MaskWidget copy() {
      return new BlockMaskWidget(this.blockConditionWidget.createState());
   }
