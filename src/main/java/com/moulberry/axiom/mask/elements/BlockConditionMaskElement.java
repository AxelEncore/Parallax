...
public class BlockConditionMaskElement implements MaskElement, GenericBlockConditionMaskElement {
   ...
   public BlockConditionMaskElement(BlockCondition blockCondition, List<BlockConditionWidget.BlockConditionState> blockConditionStates) {
   ...
   public boolean test(MaskContext context, int x, int y, int z) {
      return this.blockCondition.matches(context.getBlockState(x, y, z));
   }
