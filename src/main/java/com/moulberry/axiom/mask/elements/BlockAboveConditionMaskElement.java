...
public class BlockAboveConditionMaskElement implements MaskElement, GenericBlockConditionMaskElement {
   private final BlockCondition blockCondition;
   private final List<BlockConditionWidget.BlockConditionState> blockConditionStates;

   public BlockAboveConditionMaskElement(BlockCondition blockCondition, List<BlockConditionWidget.BlockConditionState> blockConditionStates) {
