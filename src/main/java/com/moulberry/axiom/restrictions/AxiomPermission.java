...
public enum AxiomPermission {
   ...
   BUILD_DANGEROUS_FIX_AREA(null, "axiom.build_dangerous.fix_area"),
   ...
   TOOL_BLEND(TOOL, "axiom.tool.blend"),
   ...
   private AxiomPermission(AxiomPermission parent, String name) {
      this.parent = parent;
      this.name = name;
   }
   ...
   public String getInternalName() {
      return this == DEFAULT ? "axiom.*" : this.name;
   }
}
