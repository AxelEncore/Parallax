...
public class AxiomPermissionSet {
   ...
   private void calculate() {
      if (this.explicitlyAllowed.contains(AxiomPermission.ALL)) {
         ...
         for (AxiomPermission value : PERMISSIONS) {
            ...
            } else if (!this.explicitlyDenied.contains(value) && value.parent != null && this.calculated.contains(value.parent)) {
               this.calculated.add(value);
            }
         }
      }
   ...
   public String toString() {
      ...
      return "AxiomPermissionSet{explicitlyAllowed="
         + this.explicitlyAllowed
         + ", explicitlyDenied="
         + this.explicitlyDenied
         + ", calculated="
         + this.calculated
         + "}";
   }
