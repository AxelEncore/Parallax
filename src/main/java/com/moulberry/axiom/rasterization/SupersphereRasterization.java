...
public class SupersphereRasterization {
   ...
   public static void supersphere(
   ...
   public static void supersphereMetaball(
      ChunkedBlockRegion region,
      int metaballRange,
      BlockState block,
      BlockPos center,
      ...
      if (metaballRange > 1 && level != null) {
         ...
         supersphere(region, block, center, diameterX, diameterY, diameterZ, hollow, centerEvenDiameters, Float.NEGATIVE_INFINITY, exponent, quaternionf);
      }
   }
}
